...
export default function ProfileScreen() {
  ...
  return <Screen header={<PageHeader leading={<Pressable accessibilityLabel="Back" onPress={() => router.back()} style={styles.iconButton}><ArrowLeft color={theme.text} size={22} /></Pressable>} title="Profile" subtitle={user.workspace.name} action={<Pressable accessibilityLabel="Edit profile" onPress={openEditor} style={styles.iconButton}><Pencil color={theme.text} size={20} /></Pressable>} />}>
